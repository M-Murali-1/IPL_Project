...
function economicalBowler() {
    ...
    return bowlerEconomy.sort((element1,element2)=>element1[1]-element2[1]);
...
fs.writeFileSync("../public/output/economicalBowlers2015.json",JSON.stringify({bowlerEconomy},null));
